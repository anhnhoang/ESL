...
public class ViewActivity extends ArrayAdapter<String> implements Filterable{
    ...
    public ViewActivity(Activity context, ArrayList<String> names) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        TextView studentNameTextView = (TextView) rowView.findViewById(R.id.title_textView);
		...
		String  studentId  =  info.substring(0, info.indexOf(","));
		info = info.replace(info.substring(0, info.indexOf(",")+1),"");
		String studentName = info.substring(0, info.indexOf(","));
		info = info.replace(info.substring(0, info.indexOf(",")+1),"");
		String time = info;

		dateTextView.setText(studentName);
		studentNameTextView.setText("Student Id: "+studentId);
