...
public class TutorGraph extends Activity implements OnChartValueSelectedListener, View.OnClickListener {
	EditText start,end;
	...
	public void apply() {
		...
		LinkedHashMap<String,Integer> map = db.getTutoringGraph(stime, etime);
		...
		}else
		{
			...
			Toast.makeText(this, "No records found for selectedd dates.", Toast.LENGTH_SHORT).show();
		}
